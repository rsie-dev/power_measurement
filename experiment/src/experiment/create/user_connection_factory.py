...
class BaseConnectionFactory(ConnectionFactory):
    def create_connection(self, host_info: HostInfo) -> Connection:
        return self._connection(host_info)

    @abstractmethod
    def _connection(self, host_info: HostInfo) -> Connection:
        pass


class PasswordConnectionFactory(BaseConnectionFactory):
    def __init__(self):
        super().__init__()
...
class PrivateKeyConnectionFactory(BaseConnectionFactory):
